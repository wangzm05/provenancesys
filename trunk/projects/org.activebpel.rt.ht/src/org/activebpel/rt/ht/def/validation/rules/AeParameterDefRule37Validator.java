// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.ht/src/org/activebpel/rt/ht/def/validation/rules/AeParameterDefRule37Validator.java,v 1.2 2008/02/15 17:40:56 EWittmann Exp $
/////////////////////////////////////////////////////////////////////////////
 ...
 */
public class AeParameterDefRule37Validator extends AeAbstractHtValidator
{
   ...
   protected void executeRule(AeParameterDef aDef)
   {
      ...
      {
         reportProblem(AeMessages.getString("AeParameterDefRule37Validator.0"), aDef); //$NON-NLS-1$
      }
   }
}
