// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.ht/src/org/activebpel/rt/ht/def/validation/rules/AeBusinessAdministratorsRule87Validator.java,v 1.2 2008/02/29 18:36:38 dvilaverde Exp $
/////////////////////////////////////////////////////////////////////////////
 ...
 */
public class AeBusinessAdministratorsRule87Validator extends AeAbstractHtExpressionValidator
{
   /** function QName being validated*/
   private static QName sFunctionName = new QName(IAeHtDefConstants.DEFAULT_HT_NS, IAeHtFunctionNames.BUSINESS_ADMINISTRATORS_FUNCTION_NAME);
   ...
   public void validateHtExpression(AeAbstractExpressionDef aDef, IAeExpressionParseResult aParseResult)
   {
      ...
      validateOptionalTaskNameArgument(aDef, aParseResult, sFunctionName, 0, 1);
   }
}
