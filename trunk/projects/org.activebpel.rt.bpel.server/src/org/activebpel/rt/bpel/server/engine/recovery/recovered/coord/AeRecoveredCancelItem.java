//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel.server/src/org/activebpel/rt/bpel/server/engine/recovery/recovered/coord/AeRecoveredCancelItem.java,v 1.1 2008/03/28 01:46:20 mford Exp $
/////////////////////////////////////////////////////////////////////////////
...
/**
 * Recovered item that sends the cancel signal to the participant. 
 */
public class AeRecoveredCancelItem extends AeAbstractRecoveredCoordinationItem
{
   /**
    * Ctor
    * @param aCoordId
    */
   public AeRecoveredCancelItem(String aCoordId)
   {
      super(aCoordId);
   }
   ...
   {
      aCoordManager.cancel(getCoordId());
   }
}
