//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.bpel.server/src/org/activebpel/rt/bpel/server/coord/subprocess/dispatchers/AeSubprocessCoordinationEnded.java,v 1.1 2008/03/28 01:46:19 mford Exp $
/////////////////////////////////////////////////////////////////////////////
...
/**
 * notification that the subprocess coordination has ended.
 */
public class AeSubprocessCoordinationEnded extends AeDurableSpCoordinationDispatcher
{
   /**
    * Ctor
    ...
    */
   public AeSubprocessCoordinationEnded(IAeProcessManager aProcessManager,
   ...
   {
      return getProcessManager().journalReleaseCompensationResources(getProcessId());
   }
} 