// $Header: /Development/AEDevelopment/projects/org.activebpel.rt.ht/src/org/activebpel/rt/ht/def/validation/rules/AeLogicalPeopleGroupRule106Validator.java,v 1.2 2008/02/29 18:36:38 dvilaverde Exp $
/////////////////////////////////////////////////////////////////////////////
 ...
 */
public class AeLogicalPeopleGroupRule106Validator extends AeAbstractHtExpressionValidator
{
   /** function QName being validated*/
   private static QName sFunctionName = new QName(IAeHtDefConstants.DEFAULT_HT_NS, IAeHtFunctionNames.LOGICAL_PEOPLE_GROUP_FUNCTION_NAME);
   ...
   {  
      validateOptionalTaskNameArgument(aDef, aParseResult, sFunctionName, 0, 2);
   }
}
