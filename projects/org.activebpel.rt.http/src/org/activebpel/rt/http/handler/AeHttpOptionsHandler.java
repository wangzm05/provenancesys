//$Header: /Development/AEDevelopment/projects/org.activebpel.rt.http/src/org/activebpel/rt/http/handler/AeHttpOptionsHandler.java,v 1.2 2008/03/26 15:43:27 jbik Exp $
/////////////////////////////////////////////////////////////////////////////
...
/**
 * An Http OPTIONS method handler
 */
public class AeHttpOptionsHandler extends AeHttpSendHandlerBase
{
    ...
    */
   public AeHttpOptionsHandler(AeHttpSendHandlerBase aSuccessor)
   {
      super(aSuccessor);
   }
