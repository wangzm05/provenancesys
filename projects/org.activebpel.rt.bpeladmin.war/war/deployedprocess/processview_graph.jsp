...
<%@ include file="incl_processview_graph_declaration.jsp" %>
   <head>
      ...
      <script type="text/javascript" language="JavaScript">
         ...
         nCols = 0;
         nRows = 0;
         processImageUriBase = "../processview/<%-- ASP_Conversion_Start:Substitute graphimage.aspx?--%>graphimage?<%-- ASP_Conversion_Stop --%><jsp:getProperty name="graphBean" property="pidParamName" />=<jsp:getProperty name="graphBean" property="pidParamValue" />&part=<jsp:getProperty name="graphBean" property="partId" />";         
   ...
   <body OnLoad="initGraphview();">
		<%@ include file="../processview/incl_processview_graph_body.jsp" %>   
   </body>  
</html>
