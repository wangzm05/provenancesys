...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   xmlns:htdp="http://www.example.org/WS-HT/protocol"
	...
	<!--  
		=========================================================================
		This extends the default notification (generic) template to contribute
		a tab that displays the notification xml content.
		=========================================================================
	-->	 
 	<xsl:import href="ae_escapexml.xsl" />
 	<xsl:import href="ae_default_notification.xsl" />
